...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="{{ url('/stok/export_excel') }}" class="btn btn-primary btn-sm py-1 px-2 mt-1"><i class="fa fa-fileexcel"></i> Export</a>
            <a href="{{ url('/stok/export_pdf') }}" class="btn btn-warning btn-sm py-1 px-2 mt-1"><i class="fa fa-file pdf"></i>pdf</a> 
